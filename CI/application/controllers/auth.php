...
class Auth extends CI_Controller {
	...
	function login()
	{
		...
		//validate form input
		$this->form_validation->set_rules('identity', 'e-mailadres', 'required');
		...
		if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				redirect('inloggen', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
	...
	function forgot_password()
	{
		...
		else
		{
			...
			if (!empty($forgotten))
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect("inloggen", 'refresh'); //we should display a confirmation page here instead of the login page
			}
			else
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect("wachtwoord-vergeten", 'refresh');
			}
		}
	}
