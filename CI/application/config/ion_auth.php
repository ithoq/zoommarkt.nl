 ...
 */
$config['site_title']                 = "ZoomMarkt";       // Site Title, example.com
$config['admin_email']                = "casper@noclouds.nl"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 3600000;            // The number of miliseconds to lockout an account due to exceeded attempts
