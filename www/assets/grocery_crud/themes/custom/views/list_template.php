<?php
	$this->set_css($this->default_theme_path.'/custom/css/custom.css');
	...
	$this->set_js($this->default_theme_path.'/custom/js/cookies.js');
	$this->set_js($this->default_theme_path.'/custom/js/custom.js');
	$this->set_js($this->default_theme_path.'/custom/js/jquery.form.js');
	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/custom/js/jquery.printElement.min.js');
...
<?php }
?></div>
<div class="custom" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
